            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="alert bg-light header" role="alert">
                        <h5 class="mb-1 mt-1 text-black text-capitalize">profile <?= $dataSiswa['nama'] ?></h5>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        <!-- form tambah admin -->
                                    ...
                                    <div class="col-4 text-sm-left col-lg-5" style="text-align: left;">
                                        <table class="table table-borderless">
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td><?= $dataSiswa['nohp'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>Tanggal Buat</th>
                                                <td>:</td>
                                                <td><?= $dataSiswa['tgl_buat'] ?></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
