<?php 
    ...
    $dataUser = mysqli_query($koneksi, "SELECT * FROM siswa WHERE id_siswa='$id_siswa'");
    $dataUser = mysqli_fetch_array($dataUser);

    $idBuku = $_GET['id'];
    $dataBuku = mysqli_query($koneksi, "SELECT * FROM stok_buku_koleksi WHERE id_buku_koleksi='$idBuku'");
    $dataBuku = mysqli_fetch_array($dataBuku);

    if(isset($_POST['kirim'])){
        if(insertPinjamKoleksi($_POST) > 0 ) {
            echo "<script>
            ...
            document.location.href='buku_koleksi_siswa.php';
            </script>";
        }
    }
?>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- membuat id otomatis -->
                <?php 
                $data = mysqli_query($koneksi, "SELECT MAX(id_pkoleksi) AS ID FROM tb_pinjam_koleksi_siswa");
                ...
                <div class="container-fluid">
                    <div class="alert bg-light header" role="alert">
                        <h5 class="mb-1 mt-1 text-black">Form Peminjaman Buku Koleksi</h5>
                    </div>
                    <div class="row">
                        <!-- form tambah siswa -->
                        <div class="col-12">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-12 pt-3">
                                    <div class="card">
                                        <div class="card-body">
                                            <input type="hidden" name="id_pkoleksi" value="<?= $kodeAuto ?>">
                                            <input type="hidden" name="id_buku"
                                                value="<?= $dataBuku['id_buku_koleksi'] ?>">
