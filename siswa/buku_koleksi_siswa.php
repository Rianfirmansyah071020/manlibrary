                ...
                <div class="container-fluid">
                    <div class="col-12">
                        ...
                        <div class="alert bg-light header" role="alert">
                            <h5 class="h5 mb-1 mt-1 text-black">Tabel Data Buku Koleksi Yang Ada Pada Perpustakaan
                            </h5>
                        </div>
                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-black">Tabel Data Buku Koleksi</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%"
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                            $no = 1;
                                            $dataBuku = mysqli_query($koneksi, "SELECT * FROM stok_buku_koleksi WHERE jumlah !=0 ORDER BY judul");
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a href="detail_buku_koleksi.php?id=<?= $data['id_buku_koleksi'] ?>"
                                                        class="btn btn-primary"
                                                        onclick="return confirm('apakah anda ingin melihat detail data buku ini ? ')">detail
                                                        buku</a>
                                                    <a href="pinjam_koleksi.php?id=<?= $data['id_buku_koleksi'] ?>"
