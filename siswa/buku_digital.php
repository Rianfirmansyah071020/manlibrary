                ...
                <div class="container-fluid">
                    <div class="col-12">
                        ...
                        <div class="alert bg-light header" role="alert">
                            <h5 class="mb-1 mt-1 text-black">Tabel Data Buku Digital Yang Ada Pada Perpustakaan
                            </h5>
                        </div>
                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-black">Tabel Data Buku Digital</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%"
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                            $no = 1;
                                            $datastokbuku = mysqli_query($koneksi, "SELECT * FROM tb_buku_digital ORDER BY judul ");
