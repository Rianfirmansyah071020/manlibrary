<?php 
    ...
    if (isset($_POST['save'])) {
        if (insertStokBukuKoleksi($_POST) > 0 ) {
            echo "<script>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- membuat id otomatis -->
                <?php 
                $data = mysqli_query($koneksi, "SELECT MAX(id_buku_koleksi) AS ID FROM stok_buku_koleksi");
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Form Tambah Buku Koleksi</h5>
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="pengarang" id="pengarang" required
                                                placeholder="masukan nama pengarang" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="radio" name="jenis" id="jenis" value="TEXT"> TEXT <br>
                                            <input type="radio" name="jenis" id="jenis" value="FIKSI"> FIKSI <br>
                                            <input type="radio" name="jenis" id="jenis" value="NON FIKSI"> NON FIKSI
                                        </div>
                                        <div class="form-group">
                                            <label for="hal">JUMLAH HALAMAN</label>
                                            <input type="number" name="hal" id="hal"
                                                placeholder="masukan halalaman buku" required class="form-control">
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <button type="button" class="btn btn-success mb-2" data-toggle="modal"
                                ...
                                <i class="fas fa-plus"></i> Add Buku Koleksi
                            </button>
                            <p class="mb-2 text-capitalize">Tabel ini berisikan data stok buku koleksi perpustakaan MAN
                                1 Padang
                                Pariaman</p>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-black">Tabel Data Stok Buku Koleksi</h6>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover" id="dataTable" width="100%"
                                            ...
                                            <thead class="text-center text-black">
                                                <tr>
                                                    <td colspan="7" class="text-left">
                                                        <a href="printBukuKoleksi.php" target="_blank"
                                            ...
                                            <tbody>
                                                ...
                                                <?php 
                                            $no = 1;
                                            $datastokbuku = mysqli_query($koneksi, "SELECT * FROM stok_buku_koleksi ORDER BY judul ASC");
