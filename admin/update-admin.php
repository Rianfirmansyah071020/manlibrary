<?php 
    ...
    $id = $_SESSION['login'];
    $dataAdmin1 = mysqli_query($koneksi, "SELECT * FROM admin WHERE id_admin='$id'");
    $dataAdmin1 = mysqli_fetch_assoc($dataAdmin1);
    $id = $_GET['id'];
    $dataAdmin = mysqli_query($koneksi, "SELECT* FROM admin WHERE id_admin='$id'");
    $dataAdmin = mysqli_fetch_array($dataAdmin);
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $dataAdmin1['nama'] ?></span>
                                <img class="img-profile rounded-circle"
                                    src="../assets/gambar/<?= $dataAdmin1['gambar']  ?>">
                            </a>
                ...
                <div class="container-fluid">
                    <div class="alert bg-light header" role="alert">
                        <h5 class="mb-1 mt-1 text-black text-capitalize">update data admin</h5>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        <!-- form tambah admin -->
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        <img style="border-radius: 20px;"
                                            ...
                                            alt="<?= $dataAdmin['nama'] ?>" class="image w-75 align-items-center ">
                                    </div>
                                    <div class="col-12 text-sm-left col-lg-5" style="text-align: left;">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="username" value="<?= $dataAdmin['username'] ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="password" value="<?= $dataAdmin['password'] ?>"
