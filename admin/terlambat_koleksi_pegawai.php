                ...
                <div class="container-fluid">
                    <div class="col-12">
                        ...
                        <div class="alert bg-light header" role="alert">
                            <h5 class="mb-1 mt-1 text-black">Tabel Data Terlambat Pengembalian Buku Koleksi Pegawai
                            </h5>
                        </div>
                        <!-- DataTales Example -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%"
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                            $no = 1;                                            
                                            $dataPeminjaman = mysqli_query($koneksi, "SELECT * FROM tb_pinjam_koleksi_pegawai INNER JOIN pegawai ON pegawai.id_pegawai=tb_pinjam_koleksi_pegawai.id_pegawai WHERE CURDATE() > tgl_kembali AND status='Disetujui' AND pengembalian!='Disetujui' ORDER BY id_pkoleksi DESC");
