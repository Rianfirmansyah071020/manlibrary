                ...
                <div class="container-fluid">
                    <div class="col-12">
                        ...
                        <div class="alert bg-light header" role="alert">
                            <h5 class="mb-1 mt-1 text-black">Tabel Data Peminjaman Buku Koleksi Oleh Siswa</h5>
                        </div>
                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            ...
                            if(isset($_POST['cari'])) {
                                ...
                                $dataPeminjaman = mysqli_query($koneksi, "SELECT * FROM tb_pinjam_koleksi_siswa INNER JOIN siswa ON siswa.id_siswa=tb_pinjam_koleksi_siswa.id_siswa WHERE tb_pinjam_koleksi_siswa.tanggal BETWEEN '$tglAwal' AND '$tglAkhir'");
                            }else {
                                $dataPeminjaman = mysqli_query($koneksi, "SELECT * FROM tb_pinjam_koleksi_siswa INNER JOIN siswa ON siswa.id_siswa=tb_pinjam_koleksi_siswa.id_siswa");
                            }
                                    ...
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%"
                                        ...
                                        <thead class="text-center text-black">
                                            <div class="row pb-5">
                                                ...
                                                <?php
                                                if(isset($_POST['cari'])) { ?>
                                                <a href="printPeminjamanKoleksiSiswaTgl.php?tglAwal=<?= $tgl[0]?> & tglAkhir=<?= $tgl[1]?>"
                                            ...
                                            <tr>
                                                <td colspan="15" class="text-left">
                                                    <a href="printPeminjamanKoleksiSiswa.php" class="btn btn-success"
                                                        target="_blank">Report PDF Semua Data <i
                                                            class="fas fa-upload"></i></a>
                                                    <a href="deleteAllPkoleksiSiswa.php" class="btn btn-danger"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="validasi_koleksi_siswa.php?id=<?= $data['id_pkoleksi'] ?>"
                                                    ...
                                                    <a href="validasi_kembali_koleksi_siswa.php?id=<?= $data['id_pkoleksi'] ?>"
                                                ...
                                                <td>
                                                    <a href="deletePkoleksiSiswa.php?id=<?= $data['id_pkoleksi'] ?>"
