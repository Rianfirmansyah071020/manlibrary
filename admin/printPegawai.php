<?php
    ...
    $html = '<div style="background-color: #0984b2; color:white;"><center><h3>Data Pegawai Pada Perpustakaan <br> MAN 1 PADANG PARIAMAN</h3></center></div>'.'<hr/>';    
...
$dompdf->stream('laporan_pegawai.pdf', array("Attachment"=>0));
?>