                ...
                <div class="container-fluid">
                    <div class="col-12">
                        ...
                        <div class="alert bg-light header" role="alert">
                            <h5 class="mb-1 mt-1 text-black">Tabel Data Peminjaman Buku Umum Oleh Siswa</h5>
                        </div>
                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-black">Tabel Data Peminjaman Oleh Buku Umum Siswa
                                </h6>
                            </div>
                            <?php 
                            if(isset($_POST['cari'])) {
                                ...
                                $dataPeminjaman = mysqli_query($koneksi, "SELECT * FROM tb_pinjam_umum_siswa INNER JOIN siswa ON siswa.id_siswa=tb_pinjam_umum_siswa.id_siswa WHERE tb_pinjam_umum_siswa.tanggal BETWEEN '$tglAwal' AND '$tglAkhir'");
                                
                            }else {
                                $dataPeminjaman = mysqli_query($koneksi, "SELECT * FROM tb_pinjam_umum_siswa INNER JOIN siswa ON siswa.id_siswa=tb_pinjam_umum_siswa.id_siswa");
                            }                            
                                    ...
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%"
                                        ...
                                        <thead class="text-center text-black">
                                            <div class="row pb-5">
                                                ...
                                                <?php
                                                if(isset($_POST['cari'])) { ?>
                                                <a href="printPeminjamanUmumSiswaTgl.php?tglAwal=<?= $tgl[0]?> & tglAkhir=<?= $tgl[1]?>"
                                            ...
                                            <tr>
                                                <td colspan="15" class="text-left">
                                                    <a href="printPeminjamanUmumSiswa.php" class="btn btn-success"
                                                        target="_blank">Report PDF Semua Data <i
                                                            class="fas fa-upload"></i></a>
                                                    <a href="deleteAllPumumSiswa.php" class="btn btn-danger"
                                                        onclick="return confirm('Anda yakin menghapus semua data ?')">
                                                        Hapus semua data</a>
                                                </td>
                                            </tr>
                                            <tr class="bg-light">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="validasi_umum_siswa.php?id=<?= $data['id_pumum'] ?>"
                                                        onclick="return confirm('Apakah anda ingin memvalidasi peminjaman siswa')"
                                                        class="btn btn-info">Validasi Peminjaman</a>
                                                    <?php } ?>

                                                    <?php 
                                                        if($data['pengembalian'] === "Diajukan Dan Belum Di Validasi"){ ?>
                                                    <a href="validasi_kembali_umum_siswa.php?id=<?= $data['id_pumum'] ?>"
                                                        onclick="return confirm('Apakah anda ingin memvalidasi pengembalian siswa')"
                                                ...
                                                <td>
                                                    <a href="deletePumumSiswa.php?id=<?= $data['id_pumum'] ?>"
