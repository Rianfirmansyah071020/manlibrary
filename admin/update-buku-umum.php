            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="alert bg-light header" role="alert">
                        <h5 class="mb-1 mt-1 text-black text-whitetext-capitalize">update data buku umum</h5>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        <!-- form update buku -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 text-sm-left col-lg-5" style="text-align: left;">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="id" value="<?= $dataBuku['id_buku_umum'] ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="judul" id="judul"
                                                    placeholder="masukan judul buku" autocomplete="off" required
                                                    class="form-control" value="<?= $dataBuku['judul'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="kelas">KELAS</label> <br>
                                                <input type="radio" name="kelas"
                                                    <?php if($dataBuku['kelas'] === 'X') echo "checked===checked" ?>
                                                    value="X">
                                                X
                                                <br>
                                                <input type="radio" name="kelas"
                                                    <?php if($dataBuku['kelas'] === 'XI') echo "checked===checked" ?>
                                                    value="XI"> XI <br>
                                                <input type="radio" name="kelas"
                                                    <?php if($dataBuku['kelas'] === 'XII') echo "checked===checked" ?>
                                                    value="XII"> XII
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="radio" name="jurusan"
                                                    <?php if($dataBuku['jurusan'] === 'IPA') echo "checked===checked" ?>
                                                    value="IPA"> IPA <br>
                                                <input type="radio" name="jurusan"
                                                    <?php if($dataBuku['jurusan'] === 'IPS') echo "checked===checked" ?>
                                                    value="IPS"> IPS <br>
                                                <input type="radio" name="jurusan"
                                                    <?php if($dataBuku['jurusan'] === 'IPK') echo "checked===checked" ?>
                                                    value="IPK"> IPK <br>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="penulis" id="penulis" required
                                                    ...
                                                    value="<?= $dataBuku['penulis'] ?>" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="lokasi">LOKASI PENERBIT</label>
                                                <input type="text" name="lokasi" id="lokasi" required
                                                    placeholder="masukan lokasi penerbit"
                                                    value="<?= $dataBuku['lokasi_penerbit'] ?>" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="tahun" id="tahun" required
                                                    ...
                                                    value="<?= $dataBuku['tahun_terbit'] ?>" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="bibliografi">BIBLIOGRAFI</label>
                                                <input type="number" name="bibliografi" id="bibliografi" required
                                                    placeholder="masukan bibliografi"
                                                    value="<?= $dataBuku['bibliografi'] ?>" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="isbn">ISBN</label>
                                                <input type="text" name="isbn" id="isbn" required
                                                    placeholder="masukan isbn" value="<?= $dataBuku['isbn'] ?>"
                                                    class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="indeks">INDEKS</label>
                                                <input type="number" name="indeks" id="indeks" required
                                                    placeholder="masukan indeks" value="<?= $dataBuku['indeks'] ?>"
                                                    class="form-control">
                                            </div>
                                            <div class="form-group">
