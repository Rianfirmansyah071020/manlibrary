<?php 
    ...
    if (isset($_POST['save'])) {
        if (insertPegawai($_POST) > 0 ) {
            echo "<script>
            alert('Data pegawai berhasil di simpan');
            document.location.href='pegawai.php';
            </script>";
        }
        else {
            echo "<script> 
            alert('data pegawai gagal di simpan');
            document.location.href = 'pegawai.php';
            </script>";
        }
    }
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- membuat id otomatis -->
                <?php 
                $data = mysqli_query($koneksi, "SELECT MAX(id_pegawai) AS ID FROM pegawai");
                ...
                ?>
                <?php 
                    $databidang = ["matematika","fisika","alquran hadist","sejarah kebudayaan islam", "biologi", "fiqih", "ekonomi", "kimia", "fisika", "ppkn", "bahasa inggris", "sejarah indonesia", "bahasa arab", "geografi", "bahasa indonesia", "akidah akhlak", "penjas orkes", "riset", "pkwu", "tik", "bimbingan konseling", "biologi", "sosiologi", "seni budaya", "tata usaha"];
                    ?>
                <!-- Begin Page Content -->
                <div class="container-fluid">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Form Tambah Pegawai</h5>
                                ...
                                <div class="modal-body">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="idpegawai" value="<?= $kodeAuto ?>" id="id"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <p class="mb-2 text-capitalize">Tabel ini berisikan data pegawai yang menjadi anggota
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-dark">Tabel Data Pegawai</h6>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover" id="dataTable" width="100%"
                                            ...
                                            <thead class="text-center text-dark">
                                                <tr>
                                                    <td colspan="10" class="text-left">
                                                        <a href="printPegawai.php" target="_blank"
                                            ...
                                            <tbody>
                                                ...
                                                <?php 
                                            $no = 1;
                                            $dataPegawai = mysqli_query($koneksi, "SELECT * FROM pegawai ORDER BY nama ASC");
                                            foreach ($dataPegawai as $data) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <?php if($idPegawai === $data['id_pegawai']) { ?>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="detail-pegawai.php?id=<?= $data['id_pegawai'] ?>"
                                                            class="badge rounded-pill bg-primary text-light"
                                                            onclick="return confirm('apakah anda ingin melihat detail pegawai ? ')">detail</a>
                                                        <a href="update-pegawai.php?id=<?= $data['id_pegawai'] ?>"
                                                            class="badge rounded-pill bg-info text-light"
                                                            onclick="return confirm('apakah anda ingin mengupdate data pegawai ? ')">ubah</a>
                                                        <a href="delete-pegawai.php?id=<?= $data['id_pegawai'] ?>"
                                                            class="badge rounded-pill bg-danger text-light"
                                                            onclick="return confirm('apakah anda ingin menghapus data pegawai ?')">hapus</a>
                                                    </td>
                                                </tr>
                                                <?php $no++; } ?>
                                            </tbody>
