<?php 
    ...
    if (isset($_POST['save'])){
        if (update_buku_digital($_POST) > 0 ) {
            echo "<script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="alert bg-light header" role="alert">
                        <h5 class="mb-1 mt-1 text-black text-capitalize">update data buku umum</h5>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        <!-- form update buku -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 text-sm-left col-lg-5" style="text-align: left;">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="id" value="<?= $dataBuku['id_bd'] ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="radio" name="kategori"
                                                    <?php if($dataBuku['kategori'] === "Pelajaran") echo "checked==checked" ?>
                                                    value="Pelajaran">
                                                Pelajaran <br>
                                                <input type="radio" name="kategori"
                                                    <?php if($dataBuku['kategori'] === "Koleksi") echo "checked==checked" ?>
                                                    value="Koleksi"> Koleksi
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="filelama" id="file"
                                                    value="<?= $dataBuku['file'] ?>">
