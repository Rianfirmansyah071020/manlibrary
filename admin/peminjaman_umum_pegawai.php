                ...
                <div class="container-fluid">
                    <div class="col-12">
                        ...
                        <div class="alert bg-light header" role="alert">
                            <h5 class="mb-1 mt-1 text-black">Tabel Data Peminjaman Buku Umum Oleh Pegawai</h5>
                        </div>
                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-black">Tabel Data Peminjaman Buku Umum Oleh Pegawai
                                </h6>
                            </div>
                            <?php 
                            if(isset($_POST['cari'])) {
                                ...
                                $dataPeminjaman = mysqli_query($koneksi, "SELECT * FROM tb_pinjam_umum_pegawai INNER JOIN pegawai ON pegawai.id_pegawai=tb_pinjam_umum_pegawai.id_pegawai WHERE tb_pinjam_umum_pegawai.tanggal BETWEEN '$tglAwal' AND '$tglAkhir' ");
                                
                            }else {
                                $dataPeminjaman = mysqli_query($koneksi, "SELECT * FROM tb_pinjam_umum_pegawai INNER JOIN pegawai ON pegawai.id_pegawai=tb_pinjam_umum_pegawai.id_pegawai");
                            }
                                    ...
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%"
                                        ...
                                        <thead class="text-center text-black">
                                            <div class="row pb-5">
                                                ...
                                                <?php
                                                if(isset($_POST['cari'])) { ?>
                                                <a href="printPeminjamanUmumPegawaiTgl.php?tglAwal=<?= $tgl[0]?> & tglAkhir=<?= $tgl[1]?>"
                                            ...
                                            <tr>
                                                <td colspan="15" class="text-left">
                                                    <a href="printPeminjamanUmumPegawai.php" class="btn btn-success"
                                                        target="_blank">Report PDF Semua Data <i
                                                            class="fas fa-upload"></i></a>
                                                    <a href="deleteAllPumumPegawai.php"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="validasi_umum_pegawai.php?id=<?= $data['id_pumum'] ?>"
                                                    ...
                                                    <a href="validasi_kembali_umum_pegawai.php?id=<?= $data['id_pumum'] ?>"
                                                ...
                                                <td>
                                                    <a href="deletePumumPegawai.php?id=<?= $data['id_pumum'] ?>"
