<?php
    ...
    use Dompdf\Dompdf;
    $dompdf = new Dompdf();
    $query = mysqli_query($koneksi,"SELECT * FROM tb_pinjam_koleksi_pegawai INNER JOIN pegawai ON pegawai.id_pegawai=tb_pinjam_koleksi_pegawai.id_pegawai WHERE status='Disetujui'");
    ...
    $html = '<div style="background-color: #0984b2; color:white; padding:15px;"><center><h3>Data Peminjaman Buku Koleksi Pegawai Pada Perpustakaan <br> MAN 1 PADANG PARIAMAN</h3></center> <br><span>Periode : Semua Data Peminjaman </span><br></div>'.'<hr/>';    
