    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- membuat id otomatis -->
                <?php 
                $data = mysqli_query($koneksi, "SELECT MAX(id_buku_umum) AS ID FROM stok_buku_umum");
                ...
                <div class="container-fluid">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Form Tambah Buku Umum</h5>
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="no_rak" id="no_rak"
                                                placeholder="masukan nomor atau nama rak" required class="form-control">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="radio" name="jurusan" value="IPA"> IPA <br>
                                            <input type="radio" name="jurusan" value="IPS"> IPS <br>
                                            <input type="radio" name="jurusan" value="IPK"> IPK <br>
                                        </div>
                                        <div class="form-group">
                                            <label for="penulis">PENULIS</label>
                                            <input type="text" name="penulis" id="penulis" required
                                                placeholder="masukan nama penulis" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="lokasi">LOKASI PENERBIT</label>
                                            <input type="text" name="lokasi" id="lokasi" required
                                                placeholder="masukan lokasi penerbit" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="penerbit">NAMA PENERBIT</label>
                                            <input type="text" name="penerbit" id="penerbit" required
                                                placeholder="masukan nama penerbit" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="tahun">TAHUN TERBIT</label>
                                            <input type="number" name="tahun" id="tahun" required
                                                placeholder="masukan tahun terbit" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="bibliografi">BIBLIOGRAFI</label>
                                            <input type="number" name="bibliografi" id="bibliografi" required
                                                placeholder="masukan bibliografi" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="isbn">ISBN</label>
                                            <input type="text" name="isbn" id="isbn" required placeholder="masukan isbn"
                                                class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="indeks">INDEKS</label>
                                            <input type="number" name="indeks" id="indeks" required
                                                placeholder="masukan indeks" class="form-control">
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-success mb-2" data-toggle="modal"
                            ...
                            <i class="fas fa-plus"></i> Add Buku Umum
                        </button>
                        <p class="mb-2 text-capitalize">Tabel ini berisikan data stok buku umum perpustakaan MAN 1
                            Padang
                            Pariaman</p>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-black">Tabel Data Stok Buku Umum</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%"
                                        ...
                                        <thead class="text-center text-black">
                                            <tr>
                                                <td colspan="10" class="text-left">
                                                    <a href="printBukuUmum.php" target="_blank"
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                            $no = 1;
                                            $datastokbuku = mysqli_query($koneksi, "SELECT * FROM stok_buku_umum ORDER BY judul ASC");
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a href="detail-buku-umum.php?id=<?= $data['id_buku_umum'] ?>"
                                                        class="badge rounded-pill bg-primary text-light"
                                                        onclick="return confirm('apakah anda ingin melihat detail buku ?');">detail</a>
                                                    <a href="update-buku-umum.php?id=<?= $data['id_buku_umum'] ?>"
                                                        class="badge rounded-pill bg-info text-light"
                                                        onclick="return confirm('apakah anda ingin mengupdate data buku ?')">ubah</a>
                                                    <a href="delete-buku-umum.php?id=<?= $data['id_buku_umum'] ?>"
