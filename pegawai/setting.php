            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="alert bg-light header" role="alert">
                        <h5 class="mb-1 mt-1 text-capitalize text-black">update data <?= $dataPegawai['nama'] ?></h5>
                    </div>
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <input type="hidden" name="idpegawai"
                                                    value="<?= $dataPegawai['id_pegawai'] ?>" id="id" readonly
                                                    class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="username"
                                                    value="<?= $dataPegawai['username'] ?>" id="username"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="password"
                                                    value="<?= $dataPegawai['password'] ?>" id="password"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="bidang" value="<?= $dataPegawai['bidang'] ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="radio" name="jekel" value="pria"
                                                    <?php if ($dataPegawai['jekel'] === 'pria') echo "checked=='checked'" ?>>PRIA
                                                <input type="radio" name="jekel" value="wanita"
                                                    <?php if ($dataPegawai['jekel'] === 'wanita')  echo "checked=='checked'" ?>>WANITA
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nohp" value="<?= $dataPegawai['nohp'] ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="gambarlama"
                                                    value="<?= $dataPegawai['gambar'] ?>" id="gambar">
