    ...
    <li class="nav-item">
        ...
        <div id="menubuku" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="buku_umum_pegawai.php">Buku Umum</a>
                <a class="collapse-item" href="buku_koleksi_pegawai.php">Buku Koleksi</a>
    ...
    <li class="nav-item">
        ...
        <div id="menupeminjaman" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="peminjaman_pegawai.php">Peminjaman Umum</a>
                <a class="collapse-item" href="peminjaman_koleksi_pegawai.php">Peminjaman Koleksi</a>
            </div>
        </div>
    </li>
    <!-- terlambat -->
