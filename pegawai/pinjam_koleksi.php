<?php 
    ...
    if(isset($_POST['kirim'])){
        if(insertPinjamKoleksiPegawai($_POST) > 0 ) {
            echo "<script>
            ...
            document.location.href='buku_koleksi_pegawai.php';
            </script>";
        }
    }
?>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- membuat id otomatis -->
                <?php 
                $data = mysqli_query($koneksi, "SELECT MAX(id_pkoleksi) AS ID FROM tb_pinjam_koleksi_pegawai");
                ...
                <div class="container-fluid">
                    <div class="alert bg-light header" role="alert">
                        <h5 class="mb-1 mt-1 text-black">Form Peminjaman Buku Koleksi</h4>
                    </div>
