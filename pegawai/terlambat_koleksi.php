                ...
                <div class="container-fluid">
                    <div class="col-12">
                        ...
                        <div class="alert bg-light header" role="alert">
                            <h5 class="mb-1 mt-1 text-black">Tabel Data Keterlambatan Pengembalian Buku Koleksi
                            </h5>
                        </div>
                        <!-- DataTales Example -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%"
                                        ...
                                        <tbody class="text-center">
                                            <?php  
                                        $q = mysqli_query($koneksi,"SELECT * FROM tb_pinjam_koleksi_pegawai WHERE CURDATE() > tgl_kembali AND id_pegawai='$id' AND pengembalian != 'Disetujui' AND status='Disetujui'");
